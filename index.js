...
createServer((req, res) => {
  // נתיב /reset - מוחק auth ומוציא QR חדש
  if (req.url === '/reset') {
    try { rmSync('auth_info', { recursive: true, force: true }) } catch {}
    res.writeHead(200, { 'Content-Type': 'text/html; charset=utf-8' })
    res.end(`<html><head><meta charset="utf-8"><meta http-equiv="refresh" content="5;url=/"></head><body style="background:#111;color:white;font-family:sans-serif;display:flex;justify-content:center;align-items:center;height:100vh">
      <div style="text-align:center"><h2>✅ auth נמחק!</h2><p style="color:#aaa">מעביר לדף QR בעוד 5 שניות...</p></div>
    </body></html>`)
  ...
  if (currentQR) {
    toDataURL(currentQR, (err, url) => {
      res.writeHead(200, { 'Content-Type': 'text/html; charset=utf-8' })
      res.end(`<html><head><meta charset="utf-8"><meta http-equiv="refresh" content="30"></head><body style="display:flex;justify-content:center;align-items:center;height:100vh;background:#111">
